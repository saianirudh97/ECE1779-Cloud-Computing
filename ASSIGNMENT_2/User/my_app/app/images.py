...
s3_config = {
    'bucket': 'ece1779test.s3',
    'url': 'https://s3.amazonaws.com/ece1779test.s3'
}
...
def detail(image_name):
    ...
    username = session['username']
    s3 = "https://s3.amazonaws.com/" + s3_config['bucket'] + '/'

    return render_template("detail.html", username=username, s3=s3, image_name=image_name)
